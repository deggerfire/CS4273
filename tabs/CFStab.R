...
CFS_populate_Widgets <-function(session, Graph1_selector, Graph2_selector, Graph3_selector, Graph4_selector){
  ...
  Selector_Updater(session, CFS_selectors[1], Graph1_selector, "Source of Call-Selector")
  Selector_Updater(session, CFS_selectors[2], Graph2_selector, "Police Call Status-Selector")
  Selector_Updater(session, CFS_selectors[3], Graph3_selector, "Police Call Priority-Selector")
  Selector_Updater(session, CFS_selectors[4], Graph4_selector, "City-Selector")
